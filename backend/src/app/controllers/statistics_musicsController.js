...
module.exports = {
    async store(req, res) {
        ...
        if (!musicid) {
            return res.status(400).json({ Error: 'Please, insert the music ' });
        }
...
//Maybe, I will need to implement a new logic to add statistic of this music auto.
